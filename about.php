    ...
    <section class="nav">
      ...
      <section class="discount_info">
        <table>
          <tr>
            <td>
              <img style="height: 200px; width: 200px;" src="image/happiness.png">
            </td>
            <td><b> Labdhi Shah 121 </b></td>
          </tr>
          <tr>
            <td>
              <img style="height: 200px; width: 200px;" src="image/boy.png">
            </td>
            <td><b> Rahil Shah 122</b></td>
          </tr>
          <tr>
            <td>
              <img style="height: 200px; width: 200px;" src="image/happiness.png">
            </td>
            <td><b> Dhruvi Tahilramani 129</b></td>
          </tr>
        </table>
